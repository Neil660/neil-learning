...
//        ParameterDesc param = new ParameterDesc(new javax.xml.namespace.QName("", "memberAccountLmt"), ParameterDesc.IN, new javax.xml.namespace.QName("http://www.huawei.com/ngin/vpncentrex/domain", "MemberAccountLmt"), MemberAccountLmt.class, false, false);
...
//        param.setOmittable(true);
//        oper.addParameter(param);
//        param = new ParameterDesc(new javax.xml.namespace.QName("", "responseHeader"), ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.huawei.com/ngin/vpncentrex/domain", "ResponseHeader"), ResponseHeader.class, false, false);
//        param.setNillable(true);
//        oper.addParameter(param);
//        param = new ParameterDesc(new javax.xml.namespace.QName("", "returnDes"), ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.huawei.com/ngin/vpncentrex/domain", "ReturnDes"), ReturnDes.class, false, false);
//        param.setNillable(true);
//        oper.addParameter(param);
